//
//  GTGetPrivateStreamablesTask.swift
//  GraffiTab-iOS-SDK
//
...
class GTGetPrivateStreamablesTask: GTNetworkTask {
    
    func getPrivateStreamables(offset: Int, limit: Int, successBlock: (response: GTResponseObject) -> Void, failureBlock: (response: GTResponseObject) -> Void) -> Request {
        self.sBlock = successBlock
        self.fBlock = failureBlock
        
        let url = GTRequestBuilder.buildGetPrivateStreamablesUrl(offset, limit: limit)
