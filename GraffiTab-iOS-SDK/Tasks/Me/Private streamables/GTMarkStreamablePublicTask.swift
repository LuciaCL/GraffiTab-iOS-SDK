//
//  GTMarkStreamablePublicTask.swift
//  GraffiTab-iOS-SDK
//
...
class GTMarkStreamablePublicTask : GTNetworkTask {
    
    func makePublic(streamableId: Int, successBlock: (response: GTResponseObject) -> Void, failureBlock: (response: GTResponseObject) -> Void) -> Request {
