//
//  GTGetUserLikedStreamablesTask.swift
//  GraffiTab-iOS-SDK
//
...
class GTGetUserLikedStreamablesTask: GTNetworkTask {
    
    func getLikedStreamables(userId: Int, offset: Int, limit: Int, successBlock: (response: GTResponseObject) -> Void, failureBlock: (response: GTResponseObject) -> Void) -> Request {
        self.sBlock = successBlock
        self.fBlock = failureBlock
        
        let url = GTRequestBuilder.buildGetUserLikedStreamablesUrl(userId, offset: offset, limit: limit)
