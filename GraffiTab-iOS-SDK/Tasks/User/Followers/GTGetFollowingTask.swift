...
class GTGetFollowingTask: GTNetworkTask {
    
    func getFollowing(userId: Int, offset: Int, limit: Int, successBlock: (response: GTResponseObject) -> Void, failureBlock: (response: GTResponseObject) -> Void) -> Request {
        self.sBlock = successBlock
        self.fBlock = failureBlock
        
        let url = GTRequestBuilder.buildGetFollowingUrl(userId, offset: offset, limit: limit)
