...
class GTUnfollowTask : GTNetworkTask {
    
    func unfollow(userId: Int, successBlock: (response: GTResponseObject) -> Void, failureBlock: (response: GTResponseObject) -> Void) -> Request {
