//
//  GTGetUserStreamablesTask.swift
//  GraffiTab-iOS-SDK
//
...
class GTGetUserStreamablesTask: GTNetworkTask {
    
    func getStreamables(userId: Int, offset: Int, limit: Int, successBlock: (response: GTResponseObject) -> Void, failureBlock: (response: GTResponseObject) -> Void) -> Request {
        self.sBlock = successBlock
        self.fBlock = failureBlock
        
        let url = GTRequestBuilder.buildGetUserStreamablesUrl(userId, offset: offset, limit: limit)
